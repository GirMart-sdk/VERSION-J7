/* ═══════════════════════════════════════════════════════
   WINNER — scripts/database-backup.js (PostgreSQL Backup)
   ═══════════════════════════════════════════════════════ */
"use strict";
...
const isProdMode = process.env.NODE_ENV === "production"; // Mantener la lógica de entorno
let envPath = path.resolve(__dirname, "..", isProdMode ? ".env.production" : ".env"); // Ahora apunta a la raíz desde /scripts
...
const BACKUP_DIR = path.join(__dirname, "../backups"); // La ruta a /backups sigue siendo correcta
