...
call npx --yes pm2 restart winner-backend >nul 2>&1 || (
...
echo ✅ Servidor reiniciado y guardado con PM2.
timeout /t 2 /nobreak > nul
:: Crea un archivo semáforo para indicarle al lanzador VBS que hemos terminado.
echo done > "%~dp0\sync_complete.tmp"
exit /b