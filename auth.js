...
window.doLogout = function (silent = false) {
  ...
  if (typeof window.SS !== "undefined") window.SS.set("session", null);
    ...
    loginForm.addEventListener("submit", async (e) => {
      ...
      try {
        ...
        if (data.success) {
          ...
          window.showApp();
          // ¡SOLUCIÓN! Forzar la carga de datos después de un nuevo login.
          // Sin esto, el inventario y las ventas no aparecen hasta recargar.
